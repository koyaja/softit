...
public class ClientResourceIntTest {
    ...
    private static final String DEFAULT_APIGETWAYURL = "AAAAAAAAAA";
    private static final String UPDATED_APIGETWAYURL = "BBBBBBBBBB";
    ...
    public static Client createEntity(EntityManager em) {
        Client client = new Client()
            ...
            .apigetwayurl(DEFAULT_APIGETWAYURL);
        return client;
    }
    ...
    public void createClient() throws Exception {
        ...
        assertThat(testClient.getSignature()).isEqualTo(DEFAULT_SIGNATURE);
        assertThat(testClient.getApigetwayurl()).isEqualTo(DEFAULT_APIGETWAYURL);
    }
    ...
    public void getAllClients() throws Exception {
        ...
        restClientMockMvc.perform(get("/api/clients?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].apigetwayurl").value(hasItem(DEFAULT_APIGETWAYURL.toString())));
    }
    ...
    public void getClient() throws Exception {
        ...
        restClientMockMvc.perform(get("/api/clients/{id}", client.getId()))
            ...
            .andExpect(jsonPath("$.apigetwayurl").value(DEFAULT_APIGETWAYURL.toString()));
    }
    ...
    public void updateClient() throws Exception {
        ...
        updatedClient
            ...
            .apigetwayurl(UPDATED_APIGETWAYURL);
        ...
        assertThat(testClient.getSignature()).isEqualTo(UPDATED_SIGNATURE);
        assertThat(testClient.getApigetwayurl()).isEqualTo(UPDATED_APIGETWAYURL);
    }
