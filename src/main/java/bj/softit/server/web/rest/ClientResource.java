...
public class ClientResource {
    ...
    @GetMapping("/clients/sign/{signature}")
    @Timed
    public ResponseEntity<Client> getClientBySiganture(@PathVariable String signature) {
        log.debug("REST request to get Client : {}",signature);
        Client client = clientService.findBySignature(signature);
        return ResponseUtil.wrapOrNotFound(Optional.ofNullable(client));
    }
